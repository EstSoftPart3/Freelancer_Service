...
public class AdminSeedService {
	...
	public String buildPrompt(int count) {
		...
		return """
				한국의 건설·건축·토목 현장 종사자 커뮤니티에 올릴 더미 게시글 %d건을 JSON 으로 만들어줘.
				...
				## 내용 지침
				- 시공·공정관리·안전·도면·자재·장비를 다루는 현장 실무자의 말투로 쓴다.
				...
				- QNA 는 answers 를 2~3개 넣되 서로 다른 관점(경험담·규정 인용·대안 제시)으로 쓴다.
				- 실존 회사명, 개인 이름, 연락처, 실제 주소는 넣지 않는다.
