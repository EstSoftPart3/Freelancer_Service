...
import styles from './PersonalSignUpForm.module.css'
    ...
    <>
      ...
      <div className="row">
        <div className="form-group col-lg-8">
          <label className="form-label">
            생년월일
            {validFields.dob && <i className="bi bi-check-circle-fill ms-1" style={{ color: '#007bff' }}></i>}
          </label>
          <input
            type="date"
            name="dob"
        ...
        <div className="form-group col-lg-4">
          <label className="form-label">
            성별
            {validFields.gender && <i className="bi bi-check-circle-fill ms-1" style={{ color: '#007bff' }}></i>}
          </label>
          <select
            name="gender"
            value={form.gender}
