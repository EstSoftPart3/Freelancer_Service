...
const AuthenticatedContentsFaqIndexRoute =
  AuthenticatedContentsFaqIndexRouteImport.update({
    id: '/contents/faq/',
    path: '/contents/faq/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/contents/faq/': {
      id: '/_authenticated/contents/faq/'
      path: '/contents/faq'
      fullPath: '/contents/faq/'
      preLoaderRoute: typeof AuthenticatedContentsFaqIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/contents/board/': {
